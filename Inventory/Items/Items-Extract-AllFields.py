...
try:
    ...
    csvHeader = csvHeader + "Manufactured date, Installed date, Obsolete date,Notes,Warranty,Replacement condition,Risk name,Unit of measure,Importance,Status,Current Condition,Useful Life"
    ...
    while itemCount >= RECORDCOUNT:
        ...
        for item in items["data"]: 
            ...
            csvData = csvData + '"' + str(item["currentCondition"] or '') + '",'
            csvData = csvData + '"' + str(item["designLife"] or '') + '"'
            i=0
